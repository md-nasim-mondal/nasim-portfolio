...
const CompletedProjects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: [
        "For Frontend → HTML, CSS, Tailwind CSS, Daisy UI, React JS, Firebase and some React Packages (React Tooltip, react-simple-typewriter).",
        "For Backend →Express JS, Node JS and Mongo Db.",
        "For Deploy → Frontend client side deploy in Firebase and Backend server side deployed 	to Vercel.",
      ],
      image: img2,
    },
    {
      ...
      technologies: [
        "For Frontend → HTML, CSS, Tailwind CSS, Daisy UI, React JS, Firebase and some React Packages (React Tooltip, react-simple-typewriter).",
        "For Backend →Express JS, Node JS and Mongo Db.",
        "For Deploy → Frontend client side deploy in Firebase and Backend server side deploy to Vercel.",
      ],
      image: img3,
    },
  ];
